                    ...
                    <div class="col-sm-4 wow fadeIn" data-wow-delay="0.3s">
                        <div class="border rounded p-1">
                            <div class="border rounded text-center p-4">
                                ...
                                <h2 class="mb-1" data-toggle="counter-up">71</h2>
                    ...
                    <div class="col-sm-4 wow fadeIn" data-wow-delay="0.5s">
                        <div class="border rounded p-1">
                            <div class="border rounded text-center p-4">
                                ...
                                <h2 class="mb-1" data-toggle="counter-up">133</h2>
                                <p class="mb-0">Số lần đặt phòng</p>
                            </div>
                        </div>
                    </div>
                </div>
                <a class="btn btn-primary py-3 px-5 mt-2" href="{{ route('room') }}">Khám phá ngay</a>
            </div>
            <div class="col-lg-6">
                <div class="row g-3">
