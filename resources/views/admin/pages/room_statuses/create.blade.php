        ...
        <div class="col-12">
            <div class="card">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">Thêm trạng thái phòng</h5>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('admin.room_statuses.store') }}" method="post">
                        @csrf
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="input_name" name="name"
                                    placeholder="Nhập tên trạng thái phòng" autofocus required>
                            </div>
                        </div>
                        <div class="mb-4 row align-items-center">
