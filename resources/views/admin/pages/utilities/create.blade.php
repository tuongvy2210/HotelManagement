        ...
        <div class="col-12">
            <div class="card">
                <div class="px-4 py-3 border-bottom">
                    <h5 class="card-title fw-semibold mb-0">Thêm tiện ích phòng</h5>
                </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="input_name" name="name"
                                    placeholder="Nhập tên tiện ích" autofocus required>
                            </div>
                        </div>
                        <div class="mb-4 row align-items-center">
                            <label for="input_icon" class="form-label fw-semibold col-sm-2 col-form-label">Fontawesome 5 icon</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="input_icon" name="icon"
                                    placeholder="Nhập Fontawesome icon" required>
                            </div>
                        </div>
                        <div class="mb-4 row align-items-center">
